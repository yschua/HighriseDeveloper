...
#include "highrisedev.h"
   ...
   bool C_Camera::OnEvent(const sf::Event& Event) {
     ...
     if (Event.Type == sf::Event::MouseButtonPressed) {
         if (mpInput->IsKeyDown(sf::Key::LControl) ||
             mpInput->IsKeyDown(sf::Key::RControl)) {
                 mMovingView = true;
     ...
     if (Event.Type == sf::Event::MouseWheelMoved) {
         if (Event.MouseWheel.Delta > 0) ZoomIn(); else ZoomOut();
         return true;
     }
   ...
   void C_Camera::ZoomIn() {
     Zoom(1.25f);
     //Zoom(1.25f);
   }
   void C_Camera::ZoomOut() {
     Zoom(0.8f);
     //Zoom(0.8f);
   }
   /////////////////////////////////////////////////////////////////////
   ...
   /////////////////////////////////////////////////////////////////////
   void C_Camera::Zoom(float Factor) {
   ...
   /////////////////////////////////////////////////////////////////////
   void C_Camera::Movepx(Vector2f Movement) {
   ...
   /////////////////////////////////////////////////////////////////////
   void C_Camera::Setpx(Vector2f Center) {
   ...
   /////////////////////////////////////////////////////////////////////
   bool C_Camera::CheckBounds(const sf::Rect<float>& RectToCheck) {
     if (RectToCheck.Left < mWorldRect.Left) std::cout << "Outisde of Left bound\n";
     else if (RectToCheck.Right > mWorldRect.Right) std::cout << "Outside of Right bound\n";
     else if (RectToCheck.Top < mWorldRect.Top) std::cout << "Ouside of Top bound\n";
     else if (RectToCheck.Bottom > mWorldRect.Bottom) std::cout << "Outside of Bottom bound\n";
     else return true;
     return false;
   }
   /////////////////////////////////////////////////////////////////////
   ...
   /////////////////////////////////////////////////////////////////////
   void C_Camera::AdjustBounds(sf::Rect<float>& RectToAdjust) {
     ...
     if (!CheckBounds(RectToAdjust)) std::cout << "Unable to adjust rect!";
   }
