...
//
const char* HotelImagesU[] = {"Hotel_u_n.png", "Hotel_u_d.png", "Hotel_u_0.png"};
const char* HotelImagesS[] = {"Hotel_S_u.png",
                              "Hotel_S_n.png",
                              "Hotel_S_d_0.png",
                              "Hotel_S_d_1.png",
                              "Hotel_S_d_2.png",
                              ...
                              "Hotel_S_d_4.png",
                              "Hotel_S_d_5.png"};
const char* HotelImages6[] = {"Hotel_6_n.png", "Hotel_6_d_0.png", "Hotel_6_d_1.png", "Hotel_6_d_2.png"};
const char* HotelImages7[] = {"Hotel_7_n.png",
                              "Hotel_7_d_0.png",
                              "Hotel_7_d_1.png",
                              "Hotel_7_d_2.png",
                              "Hotel_7_d_4.png",
...
void HotelRoom::SetImages(int set)
{
    ...
    manimations[HS_UnoccupiedDay] =
        new AnimationSingle(image_man->GetTexture(oi.Images[0], GL_RGBA), mWidth, 36);
    manimations[HS_UnoccupiedDay]->SetPosition(mX, mY);
    manimations[HS_UnoccupiedNight] =
        new AnimationSingle(image_man->GetTexture(oi.Images[1], GL_RGBA), mWidth, 36);
